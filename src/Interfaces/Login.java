...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, -1, -1));
        ...
        bg.add(userTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 250, 410, 30));

        jSeparator1.setForeground(new java.awt.Color(0, 0, 0));
        bg.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, 410, 20));
        ...
        bg.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 360, 410, 20));
        ...
        bg.add(loginBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 440, 130, 40));
        ...
        bg.add(jCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 370, -1, -1));
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseClicked
        ...
        String usuario2 = userTxt.getText();
        String paswd2 = passTxt.getText();
        
        if ((usuario.isEmpty() || paswd.isEmpty()) && (usuario2.isEmpty() || paswd2.isEmpty())) {
            ...
            if (usuario.equals("admin") && paswd.equals("admin")) {
                ...
                this.dispose();
            } else if (usuario2.equals("super") && paswd2.equals("super")) {
                JOptionPane.showMessageDialog(null, "Bienvenido supervisor");
                Supervisor supers = new Supervisor();
